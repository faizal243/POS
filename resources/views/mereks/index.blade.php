...
@section('content')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>ID:</strong>
                    <input type="integer" name="kd_merek" class="form-control" placeholder="kd_Merek">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
        ...
        <table id="table_id" class="display">
            <thead class="thead-dark">
                ...
                <tr>
                    ...
                    <td>{{ $merek->merek }}</td>
                    <td>
                        <form action="{{ route('mereks.destroy',$merek->kd_merek) }}" method="POST">
        
                            <a class="btn btn-info" href="{{ route('mereks.show',$merek->kd_merek) }}">
                            ...
                            <a class="btn btn-primary" href="{{ route('mereks.edit',$merek->kd_merek) }}">
