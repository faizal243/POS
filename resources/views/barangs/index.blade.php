...
<br>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <!-- <a class="btn btn-primary" href="{{ route('baranglaporan')}}" target="_blank">
     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>ID:</strong>
                <input type="integer" name="kd_barang" class="form-control" placeholder="Id">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <!-- <input type="integer" name="id_merek" class="form-control" placeholder="ID_merek"> -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <!-- <input type="integer" name="id_distributor" class="form-control" placeholder="id_distributor"> -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="string" name="harga_barang" class="form-control" placeholder="harga_barang">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Stok_barang:</strong>
                <input type="string" name="stok_barang" class="form-control" placeholder="Stok_barang">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Keterangan:</strong>
                <textarea class="form-control" style="height:110px" name="keterangan" placeholder="Keterangan"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
    ...
    <thead class="thead-dark">
        ...
        <tr>
            ...
            <td>{{ $barang->kd_merek}}</td>
            <td>{{ $barang->kd_distributor}}</td>
            <td>{{ $barang->tanggal_masuk}}</td>
            <td>{{ $barang->harga_barang}}</td>
            <td>{{ $barang->stok_barang}}</td>
            <td>{{ $barang->keterangan}}</td>
            <td>
                <form action="{{ url('barangs/'.$barang->kd_barang.'/dlt') }}" method="POST">
   
                    <a class="btn btn-info" href="{{ route('barangs.show',$barang->kd_barang) }}">
                    ...
                    <a class="btn btn-primary" href="{{ route('barangs.edit',$barang->kd_barang) }}">
