...
@section('content')
    ...
    <form action="{{ route('mereks.update',$merek->kd_merek) }}" method="POST">
        @csrf
        @method('PUT')
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>ID:</strong>
                    <input type="integer" name="kd_merek" value="{{ $merek->kd_merek }}" class="form-control" placeholder="kd_merek">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
